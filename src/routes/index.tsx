...
const benefits = [
  { icon: ShieldCheck, title: "جودة بلا تنازلات", desc: "نعتمد مواد ومعايير تنفيذ معتمدة، ونوثّق كل مرحلة لضمان نتيجة دقيقة." },
  { icon: Award, title: "خبرة هندسية حقيقية", desc: "كوادر متخصصة في العزل والمشاريع الصناعية، تتعامل مع التحديات بكفاءة." },
  { icon: Users, title: "شراكة طويلة الأمد", desc: "نبني علاقات مبنية على الشفافية والمتابعة بعد التسليم، لا مجرد عقود تنفيذ." },
  { icon: Clock, title: "التزام صارم بالمواعيد", desc: "خطة زمنية واضحة منذ اليوم الأول، وتسليم في الوقت المتفق عليه." },
];
