  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#637eb5" },
      {
        name: "keywords",
        content:
          "Waterproofing UAE, Structural protection UAE, Roof waterproofing, Thermal insulation UAE, Concrete repair, Concrete injection, Tank lining UAE, Epoxy flooring UAE, عزل مائي, عزل حراري, ترميم الخرسانة",
      },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700;800;900&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Tajawal:wght@400;500;700;800;900&display=swap",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "/",
          logo: "/logo-cascata-final.png",
          image: "/logo-cascata-final.png",
  ...
  notFoundComponent: () => (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <a
          href="/"
          className="mt-6 inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-bold text-white"
        >
          Home
        </a>
      </div>
