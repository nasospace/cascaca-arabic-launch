      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div className="flex h-12 items-center justify-center rounded-xl bg-white/[0.04] border border-white/10 px-2.5 py-1.5 shadow-sm transition-all duration-300">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="#about" className="inline-block text-white/70 hover:text-white hover:translate-x-1 transition-all duration-300">{t("nav.about")}</a></li>
            <li><a href="#why" className="inline-block text-white/70 hover:text-white hover:translate-x-1 transition-all duration-300">{t("nav.why")}</a></li>
            <li><a href="#portfolio" className="inline-block text-white/70 hover:text-white hover:translate-x-1 transition-all duration-300">{t("nav.portfolio")}</a></li>
            <li><a href="#alliances" className="inline-block text-white/70 hover:text-white hover:translate-x-1 transition-all duration-300">{t("nav.alliances")}</a></li>
            <li><a href="#contact" className="inline-block text-white/70 hover:text-white hover:translate-x-1 transition-all duration-300">{t("nav.contact")}</a></li>
          </ul>
        </div>
